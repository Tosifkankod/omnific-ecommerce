      ...
      <div className="p-3 px-5">
        {productData ? (
          <div className="first flex flex-wrap flex-col lg:flex-row ">
            {/* left */}
            <div className="left flex-1 w-[50%]   p-2">
              <Carousel>
                {productData &&
                  productData.images.map((item) => {
                    return (
                      <div
                        key={productData.id}
                        className="img-cont sm:h-[300px] md:h-[350px] lg:h-[500px] flex items-center justify-center border-yellow-300"
                      >
                        <img
            ...
            <div className="right overflow-hidden flex-1 p-2  ">
              ...
              <div className="main-price flex items-end gap-2 mt-3">
                ...
                <h1 className="text-2xl lg:text-3xl font-bold flex gap-2">
                  ₹ {productData.price} <p className="text-sm">Incl. GST</p>
                </h1>
              </div>
